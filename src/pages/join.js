...
const ContactPage = () => (
  ...
  <Section dark>
    ...
    <p>This cost includes your room and board, utilities, and three professionally cooked meals a day during the school week. The house has a full basketball court, large recreation rooms, library, laundry room, and a small gym. Spots for the Fall 2019 New Member Class are limited and filling up fast, so please contact us as soon as possible if interested. I would like to speak with each of you on a phone call at some point to set up a time when you can tour the house and meet the brothers. Take a look at our recruitment schedule below for specific dates and events we’re hosting throughout the summer. Please let me know if you plan to come to any of the events listed or if we need to set up a different time if you cannot make it to any of the times listed below. I hope you will all join us in this incredible brotherhood.</p>
    <p>Clayton Sell</p>
    <p>(316) 347-4466</p>
  ...
  <Section>
    <Row>
      ...
      <div>
        <h3>Rush</h3>
        <ul>
          <li><strong>Saturday, May 25th<br />4:00pm-6:00pm:</strong><br/>Game day @ the Sigma Pi house</li>
          <li><strong>Saturday, June 1st<br />5:00pm-7:00pm:</strong><br/>Basketball @ the Sigma Pi house</li>
          <li><strong>Saturday June 8th<br />2:00pm-4:00pm:</strong><br/>Campus tour/ House tour @ the Sigma Pi house</li>
          <li><strong>Saturday June 15th<br />TBD</strong><br/>NBA Playoffs Watch Party @ the Sigma Pi house</li>
          <li><strong>Friday June 21st thru Sunday June 23rd:</strong><br/>Formal Rush</li>
          <li><strong>Saturday June 28th<br />4pm</strong><br/>Sand Volleyball/Cookout @ the Sigma Pi house</li>
        </ul>
      </div>
    </Row>
  </Section>
